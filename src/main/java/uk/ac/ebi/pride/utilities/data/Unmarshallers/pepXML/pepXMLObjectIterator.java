...
public class pepXMLObjectIterator<X extends pepXMLObject> implements Iterator<X> {
    ...
    public pepXMLObjectIterator(String xpath, Class cls, pepXMLIndexer index, pepXMLObjectCache cache) {
        this(xpath, cls, index, cache, true);
    }

    public pepXMLObjectIterator(String xpath, Class cls, pepXMLIndexer index, pepXMLObjectCache cache, boolean aUseSpectrumCache) {
