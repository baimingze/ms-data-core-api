...
import uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.xml.jaxb.marshaller.MarshallerFactory;
import uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.xml.util.EscapingXMLStreamWriter;
...
public class pepXMLMarshaller {

    private static final Logger logger = LoggerFactory.getLogger(pepXMLMarshaller.class);
...
//
    ...
    public <T extends pepXMLObject> String marshall(T object) {
        StringWriter sw = new StringWriter();
        this.marshall(object, sw);
        return sw.toString();
    }

    public <T extends pepXMLObject> void marshall(T object, OutputStream os) {
        this.marshall(object, new OutputStreamWriter(os));
    }

    public <T extends pepXMLObject> void marshall(T object, Writer out) {
        ...
        try {
            ...
            if (!(object instanceof MsmsPipelineAnalysis)) {
...
//            XMLOutputFactory factory = XMLOutputFactory.newFactory("com.sun.xml.internal.stream.XMLOutputFactoryImpl", null);
            ...
            logger.error("pepXMLMarshaller.marshall", e);
