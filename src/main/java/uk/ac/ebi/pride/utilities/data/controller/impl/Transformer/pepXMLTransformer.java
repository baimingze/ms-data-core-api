 ...
 */
public final class pepXMLTransformer {

    /**
     * Private Constructor
     */
    private pepXMLTransformer() {
     ...
     */
    public static Spectrum transformSpectrum(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Spectrum spectrum) {
    ...
    private static String getPrecursorIonCharge(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Spectrum spectrum) {
        if(spectrum != null && spectrum.getPrecursorList() != null &&
            ...
            for(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Precursor precursor: spectrum.getPrecursorList().getPrecursor()){
                if(precursor != null && precursor.getSelectedIonList() != null && precursor.getSelectedIonList().getSelectedIon() != null){
                    for(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ParamGroup term: precursor.getSelectedIonList().getSelectedIon()){
    ...
    private static String getPrecursorMSLevel(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Spectrum spectrum) {
        if(spectrum != null && spectrum.getPrecursorList() != null &&
                spectrum.getPrecursorList().getPrecursor() != null &&
                ! spectrum.getPrecursorList().getPrecursor().isEmpty()){
            for(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Precursor precursor: spectrum.getPrecursorList().getPrecursor()){
     ...
     */
    public static <T extends uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ParamGroup> ParamGroup transformParamGroup(T paramGroup) {
     ...
     * @return ParamGroup  param group
     */
    public static <T extends uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ParamGroup> List<ParamGroup> transformParamGroupList(
     ...
     */
    public static ReferenceableParamGroup transformReferenceableParamGroupList(ReferenceableParamGroupList oldRefParamGroupList) {
        Map<String, ParamGroup> refMap = null;
        if (oldRefParamGroupList != null) {
            refMap = new HashMap<String, ParamGroup>();
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ReferenceableParamGroup> oldRefParamGroups = oldRefParamGroupList.getReferenceableParamGroup();
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ReferenceableParamGroup oldRefParamGroup : oldRefParamGroups) {
     ...
     */
    private static List<CvParam> transformCvParam(List<CvParam> newCvParams, List<CVParam> oldCvParams) {

        if (oldCvParams != null) {
            for (CVParam oldParam : oldCvParams) {
                String cvLookupID = null;
                CV cv = oldParam.getCv();
                if (cv != null)
                    cvLookupID = cv.getId();
     ...
     */
    private static List<UserParam> transformUserParam(List<UserParam> newUserParams, List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.UserParam> oldUserParams) {

        if (oldUserParams != null) {
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.UserParam oldParam : oldUserParams) {
                String unitCVLookupID = null;
                CV cv = oldParam.getUnitCv();
                if (cv != null)
                    unitCVLookupID = cv.getId();
    ...
    private static void transformReferenceableParamGroup(List<CvParam> cvParams,
                                                         ...
                                                         List<ReferenceableParamGroupRef> paramRefs) {
        if (paramRefs != null) {
            for (ReferenceableParamGroupRef ref : paramRefs) {
    ...
    private static List<BinaryDataArray> transformBinaryDataArrayList(BinaryDataArrayList binaryDataArrayList) {
        ...
        if (binaryDataArrayList != null) {
            ...
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.BinaryDataArray> oldDataArrs = binaryDataArrayList.getBinaryDataArray();

            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.BinaryDataArray oldBinaryArr : oldDataArrs) {
     ...
     */
    private static BinaryDataArray transformBinaryDataArray(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.BinaryDataArray oldBinaryArr) {
    ...
    private static List<ParamGroup> transformProductList(ProductList productList) {
        ...
        if (productList != null) {
            ...
            List<Product> oldProducts = productList.getProduct();

            for (Product oldProduct : oldProducts) {
                uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ParamGroup isowin = oldProduct.getIsolationWindow();
    ...
    private static List<Precursor> transformPrecursorList(PrecursorList precursorList) {
        ...
        if (precursorList != null) {
            ...
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Precursor> oldPrecursors = precursorList.getPrecursor();
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Precursor oldPrecursor : oldPrecursors) {
     ...
     */
    private static Precursor transformPrecursor(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Precursor oldPrecursor) {
        ...
        if (oldPrecursor != null) {
            ...
            SelectedIonList oldSelectedIonList = oldPrecursor.getSelectedIonList();
     ...
     */
    private static ScanList transformScanList(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ScanList scanList) {
        ScanList newScanList = null;

        if (scanList != null) {
            List<Scan> scans = new ArrayList<Scan>();
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Scan> oldScans = scanList.getScan();

            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Scan oldScan : oldScans) {
     ...
     * @return Scan    scan
     */
    private static Scan transformScan(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Scan oldScan) {
        Scan newScan = null;
        ...
        if (oldScan != null) {
            ...
            ScanWindowList oldScanWinList = oldScan.getScanWindowList();
     ...
     */
    public static List<SourceFile> transformSourceFileList(SourceFileList oldSourceFileList) {
        List<SourceFile> sourceFiles = null;
        if (oldSourceFileList != null) {
            sourceFiles = new ArrayList<SourceFile>();
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.SourceFile> oldSourceFiles = oldSourceFileList.getSourceFile();
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.SourceFile oldSourceFile : oldSourceFiles) {
     ...
     */
    private static SourceFile transformSourceFile(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.SourceFile oldSourceFile) {
     ...
     */
    private static ScanSetting transformScanSettings(ScanSettings oldScanSettings) {
        ...
        if (oldScanSettings != null) {
            ...
            List<SourceFileRef> oldSourceFileRefs = oldScanSettings.getSourceFileRefList().getSourceFileRef();
            for (SourceFileRef oldSourceFileRef : oldSourceFileRefs) {
     ...
     */
    private static ProcessingMethod transformProcessingMethod(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ProcessingMethod oldProcMethod) {
     ...
     */
    public static Chromatogram transformChromatogram(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Chromatogram chroma) {
     ...
     */
    public static List<CVLookup> transformCVList(CVList oldCvList) {
        List<CVLookup> cvLookups = null;
        if (oldCvList != null) {
            cvLookups = new ArrayList<CVLookup>();
            List<CV> oldCvs = oldCvList.getCv();
            for (CV oldCV : oldCvs) {
     ...
     */
    public static CVLookup transformCVLookup(CV oldCv) {
     ...
     */
    public static List<Sample> transformSampleList(SampleList oldSampleList) {
        List<Sample> samples = null;

        if (oldSampleList != null) {
            samples = new ArrayList<Sample>();
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Sample> oldSamples = oldSampleList.getSample();
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Sample oldSample : oldSamples) {
     ...
     */
    public static Sample transformSample(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Sample oldSample) {
     ...
     */
    public static List<Software> transformSoftwareList(SoftwareList oldSoftwareList) {
        List<Software> softwares = null;

        if (oldSoftwareList != null) {
            softwares = new ArrayList<Software>();
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Software> oldSoftwares = oldSoftwareList.getSoftware();
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Software oldSoftware : oldSoftwares) {
     ...
     */
    public static Software transformSoftware(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Software oldSoftware) {
     ...
     */
    public static List<ScanSetting> transformScanSettingList(ScanSettingsList oldScanSettingsList) {
        List<ScanSetting> scanSettings = null;

        if (oldScanSettingsList != null) {
            scanSettings = new ArrayList<ScanSetting>();
            List<ScanSettings> oldScanSettings = oldScanSettingsList.getScanSettings();
            for (ScanSettings oldScanSetting : oldScanSettings) {
     ...
     * @return ScanSetting scan setting
     */
    public static ScanSetting transformScanSetting(ScanSettings oldScanSetting) {
        ScanSetting scanSetting = null;

        if (oldScanSetting != null) {
            String id = oldScanSetting.getId();
            List<SourceFile> sourceFiles = new ArrayList<SourceFile>();
            List<SourceFileRef> oldSourceFileRefs = oldScanSetting.getSourceFileRefList().getSourceFileRef();
            for (SourceFileRef oldSourceFileRef : oldSourceFileRefs) {
     ...
     */
    public static List<InstrumentConfiguration> transformInstrumentConfigurationList(InstrumentConfigurationList oldInstrumentList) {
        ...
        if (oldInstrumentList != null) {
            ...
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.InstrumentConfiguration> oldInstruments = oldInstrumentList.getInstrumentConfiguration();
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.InstrumentConfiguration oldInstrument : oldInstruments) {
     ...
     */
    public static InstrumentConfiguration transformInstrumentConfiguration(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.InstrumentConfiguration oldInstrument) {
        ...
        if (oldInstrument != null) {
            ...
            // convert software
            uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Software oldSoftware = oldInstrument.getSoftware();
     ...
     */
    private static InstrumentComponent transformInstrumentComponent(Component rawComponent) {
     ...
     */
    public static List<DataProcessing> transformDataProcessingList(DataProcessingList oldDataProcessingList) {
        List<DataProcessing> dataProcessings = null;

        if (oldDataProcessingList != null) {
            dataProcessings = new ArrayList<DataProcessing>();
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.DataProcessing> oldDataProcessings = oldDataProcessingList.getDataProcessing();
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.DataProcessing oldDataProcessing : oldDataProcessings) {
     ...
     */
    public static DataProcessing transformDataProcessing(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.DataProcessing oldDataProcessing) {
        ...
        if (oldDataProcessing != null) {
            ...
            List<uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ProcessingMethod> oldProcMethods = oldDataProcessing.getProcessingMethod();
            for (uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.ProcessingMethod oldProcMethod : oldProcMethods) {
    ...
    public static List<SourceFile> transformFileDescriptionToFileSource(FileDescription rawFileDescription) {
        if (rawFileDescription != null) {
            SourceFileList rawSourceFileList = rawFileDescription.getSourceFileList();
