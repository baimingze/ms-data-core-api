...
//    Product(                    "product",                      true,       "/mzML/run/spectrumList/spectrum/productList/product",                                          false,      Product.class,                      false,          null),
    Product(getCfg().get(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Product.class.getName()).getTagName(),
            getCfg().get(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Product.class.getName()).isIndexed(),
            getCfg().get(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Product.class.getName()).getXpath(),
            getCfg().get(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Product.class.getName()).isIdMapped(),
            getCfg().get(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Product.class.getName()).getClazz(),
            getCfg().get(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Product.class.getName()).isAutoRefResolving(),
            getCfg().get(uk.ac.ebi.pride.utilities.data.Unmarshallers.pepXML.model.pepxml.Product.class.getName()).getRefResolverClass()),
