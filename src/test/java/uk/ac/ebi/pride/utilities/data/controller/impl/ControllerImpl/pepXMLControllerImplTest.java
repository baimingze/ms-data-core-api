 ...
 * @author Rui Wang
 */
public class pepXMLControllerImplTest {

    private pepXMLControllerImpl pepXMLController = null;
    ...
    public void setUp() throws Exception {
        ...
        pepXMLController = new pepXMLControllerImpl(inputFile);
    }

    @After
    public void tearDown() throws Exception {
        pepXMLController.close();
    }

    @Test
    public void testGetExperimentMetaData() throws Exception {
        ExperimentMetaData metada = pepXMLController.getExperimentMetaData();
    ...
    public void testGetSamples() throws Exception {
        List<Sample> samples = pepXMLController.getSamples();
    ...
    public void testGetSoftware() throws Exception {
        List<Software> softwares = pepXMLController.getSoftwares();
    ...
    public void testGetScanSettings() throws Exception {
        List<ScanSetting> scanSettings = pepXMLController.getScanSettings();
    ...
    public void testGetInstrumentConfigurations() throws Exception {
        List<InstrumentConfiguration> instrumentConfigurations = pepXMLController.getInstrumentConfigurations();
    ...
    public void testGetDataProcessings() throws Exception {
        List<DataProcessing> dataProcessings =pepXMLController.getDataProcessings();
    ...
    public void testGetSpectrumIds() throws Exception {
        List<Comparable> ids = new ArrayList<Comparable>(pepXMLController.getSpectrumIds());
    ...
    public void testGetSpectrumById() throws Exception {
        Spectrum spectrum = pepXMLController.getSpectrumById("scan=20");
    ...
    public void testGetChromatogramIds() throws Exception {
        List<Comparable> ids = new ArrayList<Comparable>(pepXMLController.getChromatogramIds());
    ...
    public void testGetChromatogramById() throws Exception {
        Chromatogram chromatogram = pepXMLController.getChromatogramById("tic");
